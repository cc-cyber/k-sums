...
bool XBKSums::optzIm(const unsigned int odlbl, const unsigned int nwlbl)
{
...
bool XBKSums::optzIs(const unsigned int odlbl, const unsigned int nwlbl)
{
    double distA = 0, distB = 0;
    unsigned int sz = 0, _loc1 = 0, _loc2 = 0, _loc3 = 0;
    unsigned int x = 0, c0 = 0, c1 = 0, index = 0;
...
void XBKSums::test()
{
    ...
    mytm->start();
    mykm->buildcluster(srcFn1, dstFn1, "non", "large", "i2", 1024, false);
    mytm->end(true);
    return;
}
